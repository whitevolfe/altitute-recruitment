      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal delay={0.15}>
          <p className="text-muted-foreground font-body font-light text-lg leading-relaxed max-w-3xl mb-20">
            Altitude Group connects high-performing professionals with leading global
            businesses. We specialise in executive search, C-suite hiring, and
            industry-specific recruitment across tech, finance, marketing, PR and
            creative sectors.
          </p>
        </ScrollReveal>
