    ...
    <section className='min-h-screen bg-black relative overflow-hidden'>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6 py-20'>
        <div className='grid lg:grid-cols-2 gap-16 items-center min-h-[70vh]'>
          ...
          <ScrollReveal>
            <h2 className='text-5xl md:text-7xl lg:text-7xl font-display font-bold text-white leading-tight max-w-2xl'>
          ...
          <ScrollReveal delay={0.2}>
            <div className='grid grid-cols-2 gap-6'>
              ...
              <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300'>
                ...
                <p className='text-white/360 text-xl leading-relaxed'>2000+</p>
              </div>

              {/* Card 2 */}
              <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300'>
                <h3 className='text-3xl font-bold text-white mb-2'>Clients</h3>
                <p className='text-white/360 text-xl leading-relaxed'>50+</p>
              </div>
              ...
              <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300'>
                ...
                <p className='text-white/360 text-xl leading-relaxed'>98%</p>
              </div>
              ...
              <div className='bg-white/5 backdrop-blur-sm border border-red-500/30 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300'>
                ...
                <p className='text-white/3600 text-xl leading-relaxed'>50+</p>
              </div>
            </div>
          </ScrollReveal>
        </div>
