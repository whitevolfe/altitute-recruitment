            ...
            <div className='grid grid-cols-2 gap-6'>
              ...
              <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300'>
                ...
                <p className='text-white/80 text-sm leading-relaxed'>
                  Pioneering fintech innovation with cutting-edge technology and
              ...
              <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300'>
                ...
                <p className='text-white/80 text-sm leading-relaxed'>
                  Expert traders and analysts driving market success.
                </p>
              </div>
              ...
              {/* Card 4 - Highlight */}
              <div className='bg-red-600/90 backdrop-blur-sm border border-red-500/30 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300'>
                <h3 className='text-2xl font-bold text-white mb-2'>
                  Placements
                </h3>
                <p className='text-white/90 text-sm leading-relaxed'>
                  Global network empowering traders worldwide.
                </p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <div className='mt-20 pt-16 border-t border-white/10'>
            <div className='grid grid-cols-2 md:grid-cols-4 gap-8 text-center'>
              <div>
                ...
                <p className='text-3xl font-bold text-white'>220K+</p>
              </div>
              <div>
                <h4 className='text-white/70 text-sm uppercase tracking-wider mb-2'>
                  TRUSTED BY NATIONS
              ...
              <div className='col-span-2 md:col-span-1'>
                ...
                <p className='text-white/80 text-sm leading-relaxed'>
                  To revolutionize global trading with cutting-edge technology
