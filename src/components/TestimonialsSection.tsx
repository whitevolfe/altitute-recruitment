...
const testimonials = [
  ...
  {
    quote:
      'Charitha and Natlie helped me find the perfect role, and I couldn’t be happier. They really took the time to understand my skills and what I actually wanted to do in my role. Every step of the process was smooth, thanks to their clear communication and constant support. What I appreciate most is how trustworthy and supportive they are. It felt like having someone in my corner who truly wanted the best for me. Charitha is a solid guy with a great heart. With his and Natlie’s expertise, it’s easy to see why Altitude Talent will shine. They aren’t just great at matching people with jobs, they are great at matching people with the right jobs. I highly recommend working with them. The best doors open when the right people knock.',
    name: 'SEO Specialist',
    // company: 'Meridian Finance Group',
    initials: 'SS',
  },
  {
    quote:
      'Charitha and Natlie are two of the best Recruiters I have ever met. The approach they have on candidates and their ability to provide a service that’s beyond a regular recruiter is admirable. They go above and beyond to support the process of recruitment and check on both the candidate / client requirements very well, a rare scenario in the recruitment space. I recommend Charitha and Natlie as an asset to any organization. Wishing them the best of luck!',
